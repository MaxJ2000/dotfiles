...
- CLI
    ...
    - [Xfce-polkit](https://github.com/ncopa/xfce-polkit) - Polkit agent.
    - [Xfce-Power-Manager](https://www.archlinux.org/packages/extra/x86_64/xfce4-power-manager/) Power-manager and key binding for fn-key.
- GUI
    ...
    - [Guake](http://guake-project.org/) - An out of box drop-down terminal.
...
- Thinkpad X1 Carbon 6th with 2K
